...
const { Item, getAllItemsModel, getItemById, getMenItemsModel, deleteItemModel } = require("../models/item");
...
const getMenItems = async function () {
    return await getMenItemsModel()
}
